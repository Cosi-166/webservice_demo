...
result = Typhoeus.get("https://www.quandl.com/api/v3/datasets/WIKI/TWTR/data.json?order=asc&exclude_column_names=true&start_date=2012-01-01&end_date=2017-01-01&column_index=4&collapse=annual&transformation=rdiff")
